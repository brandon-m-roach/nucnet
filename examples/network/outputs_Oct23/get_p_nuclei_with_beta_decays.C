...
//output file
sprintf(outPath1, "results/pnuclei_X_vs_solar_beta_decayed.dat");
...
cout << "Done. Check output files: results/pnuclei_X_vs_solar_beta_decayed.dat" << endl;
